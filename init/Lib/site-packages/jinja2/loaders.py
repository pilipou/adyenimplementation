...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'dropin.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/dropin.html'`` the file from the app1 package is loaded,
    by loading ``'app2/dropin.html'`` the file from the second.
    """
